...
# Automatischer Reset bei URL-Parameter "reset"
...
# Barcode erzeugen & Druckfenster öffnen
if gtin and len(gtin) in [8, 12, 13, 14] and not st.session_state.printed:
    try:
        ...
        # HTML-Seite zum Drucken mit JS-Auto-Reset nach 2 Sekunden
        html = f"""
        <html>
        <head>
        <meta charset="utf-8">
        ...
        <body onload="window.print(); setTimeout(() => window.location.search = '?reset', 2000);">
